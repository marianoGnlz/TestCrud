        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Operaciones_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descripcion = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MyProperty = table.Column<TimeSpan>(type: "time", nullable: false),
                    Disp_Alquiler = table.Column<int>(type: "int", nullable: false),
                    Disp_Venta = table.Column<int>(type: "int", nullable: false),
